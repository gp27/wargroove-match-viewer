...
export function generatePalette(paletteKey: string, canvas: HTMLImageElement | HTMLCanvasElement, names: string[]) {
...
export function applyPalette(source: HTMLCanvasElement | HTMLImageElement, paletteKey: string, from: string, to: string){
